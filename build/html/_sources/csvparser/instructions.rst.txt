...
.. toctree::
   ...
   Obtendo dados <instructions/getdata>
   Customizando o retorno <instructions/setcolumns>
   Filtrando dados <instructions/filter>


Para as instruções que serão fornecidas à seguir, considere o seguinte arquivo como exemplo:
